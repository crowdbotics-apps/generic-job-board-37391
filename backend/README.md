...
## Project Structure
    ...
    ├── generic_job_board_37391  # Django project configurations
...
1. Clone this repo and `cd generic_job_board_37391`
...
2. Clone this repo and `cd generic_job_board_37391`
